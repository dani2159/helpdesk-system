            ...
            <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    ...
                    <div class=" ms-auto mb-2 mb-lg-0" id="navbarSupportedContent">
                        <form class="d-flex align-items-center" action="{{ route('ticket.search') }}" method="GET">
                            <input class="form-control me-2" type="search" placeholder="Search Ticket"
                                aria-label="Search" name="ticket">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Please fill out the following form to report an issue to the IT department.</p>
                                ...
                                <form action="{{ route('ticket.store') }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label class="form-label">Service Level Agreement <span
                                                    class="text-danger">*</span></label>
                                            <select name="sla_id" id="sla_id" class="form-control" required
                                                name="sla_id">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label class="form-label">To Department <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label class="form-label">Employee NIP Reporting <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control"
                                                placeholder="Employee NIP Reporting" required name="nip">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="form-label">From Department <span
                                                    class="text-danger">*</span></label>
                                            <select name="from_divisi_id" id="from_divisi_id" class="form-control"
                                                required>
                                                <option value="">Select Department</option>
                                                @foreach ($divisi as $item)
                                                    <option value="{{ $item->id }}">{{ $item->nama_divisi }}
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <button type="submit" name="next" class="btn btn-primary col-md-12"
                                                value="Next"><b>⚠️ REPORT TROUBLE ⚠️</b> </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
